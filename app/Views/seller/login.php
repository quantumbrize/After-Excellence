...
<head>
    ...
    <meta charset="utf-8" />
    <title>Sign In | Atomz - Admin & Dashboard</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta content="Premium Multipurpose Admin & Dashboard Template" name="description" />
    <meta content="Themesbrand" name="author" />
    <!-- App favicon -->
    <link rel="shortcut icon" href="<?=base_url()?>public/assets/images/Atomz-logo1.png">
                    ...
                    <div class="col-lg-12">
                        <div class="text-center">
                            <p class="mb-0 text-muted">&copy;
                                <script>document.write(new Date().getFullYear())</script> Atomz Developed by <a href="https://www.quantumbrize.com/" target="_blank">Quantum Brize</a>
                            </p>
                        </div>
                    </div>
                </div>
