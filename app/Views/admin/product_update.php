        ...
        <div id="createproduct-form">
            <div class="row">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <label for="file-input" id="btn_upload" class="btn btn-success">
                                <i class="fas fa-upload"></i> &nbsp; Select Course Image
                            </label>
                            <p id="num-of-files"></p>
                            <div id="images"></div>
                        </div>
                ...
                <div class="card">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group has-validation mb-3">
                                                    ...
                                                    <input type="hidden" class="form-control" id="product-starting-date-input"
                                                        placeholder="Enter starting date" aria-label="Price"
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input type="hidden" class="form-control" id="product-max-student-input"
                                                        placeholder="Enter maximum student" aria-label="discount"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group has-validation mb-3">
                                                ...
                                                <input type="text" class="form-control" id="product-price-input"
                                                    ...
                                                    aria-describedby="product-price-addon" required="">
                                                <div class="invalid-feedback">Please Enter a Course price.</div>
                                            </div>
                    ...
                    <input type="hidden" id="datepicker-publish-input" class="form-control" value="15-01-2030" data-date-format="d.m.y" data-enable-time="">
