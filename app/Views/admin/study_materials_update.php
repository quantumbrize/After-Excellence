    ...
    <div class="container-fluid">
        ...
        <div id="createproduct-form">
            <div class="row">
                    ...
                    <div class="card">
                        <div class="card-body row">
                            <div class="col-lg-4 mb-3">
                                ...
                                <fieldset>
                                    <label for="option1">
                                        <input type="radio" id="option1" name="materialOptions" value="pdf">
                                       PDF
                                    </label>
                                    <label for="option2">
                                ...
                                <div class="col-lg-12 mb-3" id="upload_pdf" style="display:none;">
                                    <!-- <label for="file-input">Choose PDF File</label> -->
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-8">
                                            <iframe src="" id="pdf_data" frameborder="0"></iframe>
                                        </div>
                                    </div>
                ...
                <input type="hidden" id="study_material_id">
        ...
        <div class="text-start mb-3">
            <button class="btn btn-success w-sm" id="study_material_update_btn">Submit</button>
        </div>
    </div>
    <!-- container-fluid -->
</div>