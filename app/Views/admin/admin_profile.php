                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="personalDetails" role="tabpanel">
                                <form action="javascript:void(0);">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="text-end">
                                            <button type="submit" id="update_profile" class="btn btn-success"><i
                            ...
                            <div class="tab-pane" id="settings" role="tabpanel">
                                <form action="javascript:void(0);">
                                    <div class="row g-2">
                                        <div class="col-lg-4">
                                            <div>
                                                <label for="fedbackInput" class="form-label">Teachers Feedback</label>
                                                <select class="form-control" id="fedbackInput">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="text-end">
                                                <button type="submit" id="save_settings"
