                ...
                success: function (resp) {
                    ...
                    if (resp.status) {
                        ...
                        let html = `<tr>
                                    ...
                                    <tr>
                                        <td>About Course</td>
                                        <td style="text-align: right" class="text-secondary">${product.about_product}</td>
                                    </tr>
                                    <tr>
                                        <td>Video Url</td>
                                        <td style="text-align: right" class="text-secondary">${product.video_url}</td>
                                    </tr>
                                    <tr>
                                        <td>Duration</td>
                                        <td style="text-align: right" class="text-secondary">${product.duration}</td>
                                    </tr>
                                    `
                        $('#product_details').html(html);

                        let course_img = `<img src="<?= base_url('public/uploads/product_images/') ?>${product.product_img[0].src}" alt="" class="course-img">
                                            <div class="text-center">
                                                <p class="course_name">${product.name}</p>
                                                <p class="course_code">${product.product_code}</p>
                                                <p class="course_description">${product.description}</p>
                                            </div>`
                        $('#course_image').html(course_img);
                        load_variants();
                    }
                },
                error: function (err) {
