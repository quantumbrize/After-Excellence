<script>
    ...
    $(document).ready(function () {
        ...
        $('#popular_paper_add_btn').on('click', function () {
            ...
            $.ajax({
                url: "<?= base_url('/api/add/popular-paper') ?>",
                type: "POST",
                data: formData,
                contentType: false,
                processData: false,
                beforeSend: function () {
                    $('#popular_paper_add_btn').html(`<div class="spinner-border" role="status"></div>`)
                    $('#popular_paper_add_btn').attr('disabled', true)
                ...
                complete: function () {
                    $('#popular_paper_add_btn').html(`submit`)
                    $('#popular_paper_add_btn').attr('disabled', false)
                }
            })
        })
