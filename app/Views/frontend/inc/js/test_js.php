<script>
    $(document).ready(function () {
        load_online_tests('<?= $_GET['test_id'] ?>')
    });
    ...
    function load_online_tests(test_id) {
        $.ajax({
                ...
                if (resp.status) {
                    ...
                    $.each(resp.data[0].questions, function (index, question) {
                        ...
                        if (question.question_type == 'saq') {
                            ...
                            answers = `<label><input type="radio" name="customRadio-${question.uid}" value="${question.answer[0].a}" /> A) ${question.answer[0].a}</label>
                                        <br />
                                        <label><input type="radio" name="customRadio-${question.uid}" value="${question.answer[0].b}" /> B) ${question.answer[0].b}</label>
                                        <br />
                                        <label><input type="radio" name="customRadio-${question.uid}" value="${question.answer[0].c}" /> C) ${question.answer[0].c}</label>
                                        <br />
                                        <label><input type="radio" name="customRadio-${question.uid}" value="${question.answer[0].d}" /> D) ${question.answer[0].d}</label>
                                    `;
                        }
                        html += `
                                <div class="question">
