<div class="teacher-container">
            <nav class="navbar">
                <ul>
                    ...
                    <li><a href="<?= base_url('papers')?>" class="nav-link"><i class="fas fa-file-alt"></i>PAPER</a></li>
                    <li><a href="test.html" class="nav-link"><i class="fas fa-tasks"></i>ASSIGNMENT</a></li>
