            ...
            <div class="container">
                <div class="breadcrumb-inner">
                    ...
                    <div class="page-title">
                        <h1 class="title" id="course_title"></h1>
                    </div>
                ...
                <div class="row row--30">
                    <div class="col-lg-8">
                        ...
                        <div class="course-overview">
                                <h3 class="heading-title" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">Course Details</h3>
                                <p data-sal-delay="150" data-sal="slide-up" data-sal-duration="800" id="course_details"></p>
                            </div>
                            <div class="course-overview">
                                <h3 class="heading-title" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">About This Course</h3>
                                <p data-sal-delay="150" data-sal="slide-up" data-sal-duration="800" id="about_course"></p>
                                ...
                                <!-- <h3 class="heading-title" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">Requirements</h3>
                                <ul class="mb--90" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                                ...
                                <!-- <h3 class="heading-title" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">Target Audience</h3>
                                <ul class="mb--90" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                            ...
                            <!-- <div class="course-curriculam mb--90">
                                <h3 class="heading-title" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">Topics for This Course</h3>
                            ...
                            <div class="course-instructor-wrap mb--90" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                                <h3 class="heading-title">Institute: Atomz</h3>
                                <!-- <div class="course-instructor">
                                    <div class="thumbnail" id="course_lecturer">
                                        <img src="<?=base_url()?>public/assets/images/course/author-01.png" alt="Author Images">
                                    </div>
                                    <div class="author-content">
                                        <h6 class="title" id="course_lecturer_name"></h6>
                                        <span class="subtitle" id="course_lecturer_role"></span>
                    ...
                    <div class="col-lg-4">
                        <div class="course-sidebar-3">
                            <div class="edu-course-widget widget-course-summery">
                                <div class="inner">
                                    <div class="thumbnail" id="course_image">
                                        <!-- <img src="<?=base_url()?>public/assets/images/course/course-46.jpg" alt="Courses"> -->
                                    ...
                                    <div class="content">
                                        ...
                                        <ul class="course-item" id="course_includes">
                                            <!-- <li>
                                            ...
                                            <li>
                                                <span class="label"><img class="svgInject" src="<?=base_url()?>public/assets/images/svg-icons/books.svg" alt="book icon">Lessons:</span>
                                        ...
                                        <div class="read-more-btn" id="start_now">
                                            <!-- <a class="edu-btn" onclick="add_to_cart()">Start Now <i class="icon-4"></i></a> -->
                                        </div>
