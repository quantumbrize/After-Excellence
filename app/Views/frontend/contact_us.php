                            ...
                            <!-- <form class="rnt-contact-form rwt-dynamic-form" id="contact-form" method="POST" action="mail.php"> -->
                                <div class="row row--10">
                                    <div class="form-group col-12">
                                        ...
                                        <span style="color:red;" id="nameInput_val"></span>
                                    </div>
                                    <div class="form-group col-12">
                                        <input type="email" name="contact-email" id="contact-email" placeholder="Enter your email">
                                        <span style="color:red;" id="emailInput_val"></span>
                                    </div>
                                    <div class="form-group col-12">
                                        <input type="tel" name="contact-phone" id="contact-phone" placeholder="Phone number">
                                        <span style="color:red;" id="phoneInput_val"></span>
                                    </div>
                                    <div class="form-group col-12">
                                        <input type="tel" name="contact-phone" id="contact-subject" placeholder="Subject">
                                        <span style="color:red;" id="subjectInput_val"></span>
                                    </div>
                                    <div class="form-group col-12">
                                    ...
                                    <div class="form-group col-12">
                                        <button class="rn-btn edu-btn btn-medium submit-btn" name="submit" id="getInTouchSubmit">Submit Message <i class="icon-4"></i></button>
                                    </div>
                                </div>
                            <!-- </form> -->
                            <ul class="shape-group">
                                <li class="shape-1 scene"><img data-depth="1" src="<?=base_url()?>public/assets/images/about/shape-13.png" alt="Shape"></li>
                                <li class="shape-2 scene"><img data-depth="-1" src="<?=base_url()?>public/assets/images/counterup/shape-02.png" alt="Shape"></li>
                            </ul>
                        </div>
                    </div>
                </div>
