...
<div class="offcanvas offcanvas-end product-list" tabindex="-1" id="ecommerceCart" aria-labelledby="ecommerceCartLabel">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="card-header border-bottom-dashed p-4">
                                        <div class="d-sm-flex">
                                            <div class="flex-grow-1">
                                                <img src="<?= base_url()?>/public/assets/images/logo-dark-1.png" class="card-logo card-logo-dark" alt="logo dark" height="26">
                                                <img src="<?= base_url()?>/public/assets/images/logo-light-1.png" class="card-logo card-logo-light" alt="logo light" height="26">
                                            ...
                                            <div class="flex-shrink-0 mt-sm-0 mt-3">
                                                ...
                                                <h6><span class="text-muted fw-normal">Email:</span> <span id="email">toner@themesbrand.com</span></h6>
                                                ...
                                                <h6 class="mb-0"><span class="text-muted fw-normal">Contact No: </span><span id="contact-no"> +(314) 234 6789</span></h6>
                                            </div>
                                        </div>
                                    </div>
                                    <!--end card-header-->
                                    ...
                                    <div class="card-body p-4">
                                        <div class="row g-3">
                                            ...
                                            <div class="col-lg-3 col-6">
                                                ...
                                                <h5 class="fs-15 mb-0"><span id="invoice-date">14 Jan, 2023</span> <small class="text-muted" id="invoice-time">12:22PM</small></h5>
                                            </div>
                                            <!--end col-->
                                            <div class="col-lg-3 col-6">
                                ...
                                <div class="col-lg-12">
                                    <div class="card-body p-4">
                                                ...
                                                <tbody id="products-list">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-start">
                                                            ...
                                                            <p class="text-muted mb-0">large display of 40mm (1.6″ inch), 27 sports mode, SpO2 monitor</p>
                                                        </td>
                                                        <td>$247.27</td>
                                                        <td>01</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-start">
                                                            ...
                                                            <p class="text-muted mb-0">Fabric:Synthetic · Color:Green · Shoe Type:Sandals</p>
                                                        </td>
                                                        <td>$24.07</td>
                                                        <td>05</td>
                                        ...
                                        <div class="mt-3">
                                            ...
                                            <p class="text-muted mb-1">Card Holder: <span class="fw-medium" id="card-holder-name">Raquel Murillo</span></p>
        ...
        <section class="section bg-light bg-opacity-25" style="background-image: url('<?= base_url()?>/public/assets/images/ecommerce/bg-effect.png');background-position: center; background-size: cover;">
            <div class="container">
                <div class="row align-items-center justify-content-between">
                    <div class="col-lg-6">
                        <div>
                            ...
                            <p class="fs-15 mb-4 pb-2">Start You'r Daily Shopping with <a href="#!" class="link-secondary fw-medium text-decoration-underline">Toner</a></p>
                            <form action="#!">
                                <div class="position-relative ecommerce-subscript">
                    ...
                    <div class="col-lg-4">
                        <div class="mt-4 mt-lg-0">
                            <img src="<?= base_url()?>/public/assets/images/ecommerce/subscribe.png" alt="" class="img-fluid">
                        </div>
                    </div>
                </div>
            </div>
