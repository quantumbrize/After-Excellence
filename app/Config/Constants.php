...
defined('TABLE_COURSE_LECTURER')    || define('TABLE_COURSE_LECTURER',      'course_lecturer');
defined('TABLE_LIVE_CLASS')         || define('TABLE_LIVE_CLASS',           'live_class');
defined('TABLE_QUESTIONS')          || define('TABLE_QUESTIONS',            'questions');
defined('TABLE_ANSWERS')            || define('TABLE_ANSWERS',              'answers');
defined('TABLE_TESTS')              || define('TABLE_TESTS',                'tests');
defined('TABLE_CITIES')             || define('TABLE_CITIES',               'cities');
defined('TABLE_CENTRES')             || define('TABLE_CENTRES',             'centres');
...
defined('UID_COURSE_LECTURER')      || define('UID_COURSE_LECTURER','PROF');
defined('UID_LIVE_CLASS')           || define('UID_LIVE_CLASS',     'LIVCLS');
defined('UID_CLASS')                || define('UID_CLASS',          'CLS');
defined('UID_BRANCH')               || define('UID_BRANCH',         'BRNCH');
defined('UID_STUSENT')              || define('UID_STUSENT',        'STD');
defined('UID_TESTS')                || define('UID_TESTS',          'TST');
defined('UID_QUESTIONS')            || define('UID_QUESTIONS',      'QST');
defined('UID_ANSWERS')              || define('UID_ANSWERS',        'ANS');
defined('UID_ROLL')                 || define('UID_ROLL',           'ROL');
defined('UID_ROLL')                 || define('UID_ROLL',            'ROL');
defined('UID_CITY')                 || define('UID_CITY',            'CTY');
defined('UID_CENTRES')              || define('UID_CENTRES',         'CNTR');
defined('UID_ADMIT_FORM')           || define('UID_ADMIT_FORM',      'ADFO');
defined('UID_IMPORTANT_NOTE')       || define('UID_IMPORTANT_NOTE',  'IMPNOT');
defined('UID_SUBMIT_USER_DATA')     || define('UID_SUBMIT_USER_DATA', 'SUD');
defined('UID_UNSIGNED_USER_RESULT') || define('UID_UNSIGNED_USER_RESULT', 'UNUSRE');
...
defined('PATH_STUDY_MATERIAL')      || define('PATH_STUDY_MATERIAL', ROOTPATH  . 'public/uploads/study_material');
defined('PATH_POPULAR_PAPER')       || define('PATH_POPULAR_PAPER', ROOTPATH  . 'public/uploads/popular_paper');
defined('PATH_QUESTION_IMG')        || define('PATH_QUESTION_IMG', ROOTPATH  . 'public/uploads/question_img');
